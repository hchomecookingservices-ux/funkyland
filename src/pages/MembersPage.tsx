...
export default function MembersPage() {
  ...
  const selectedMemberHistory = useMemo(() => {
    ...
    const memberInvoices = invoices.filter(inv => 
      inv.phoneNumber === member.phoneNumber
    );
  ...
  const [formData, setFormData] = useState({
    ...
    childAge: '',
    phoneNumber: '',
    planId: plans.find(p => p.type === 'subscription')?.id || plans[plans.length-1].id,
    medicalNotes: ''
  });
  ...
  const handleExportMembers = () => {
    ...
    exportToCSV(dataToExport, 'FunkyLand_Members');
  };
  ...
  const handleWhatsAppContact = (member: any) => {
    ...
    window.open(formatWhatsAppLink(member.phoneNumber, message), '_blank');
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const gstAmount = (baseAmount * selectedPlan.gstSlab) / 100;
    ...
    addInvoice({
      ...
      items: [{
        id: 'MEM-SUB',
        description: `Membership Registration: ${selectedPlan.name}`,
        type: 'service',
        quantity: 1,
        unitPrice: baseAmount,
        gstSlab: selectedPlan.gstSlab as any,
        amount: totalAmount
      }],
                ...
                <div className="p-6 space-y-6">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="font-black text-slate-800 text-lg leading-tight">{member.childName}</h3>
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <button 
                        ...
                        className="p-2 bg-emerald-50 text-emerald-600 rounded-xl hover:bg-emerald-500 hover:text-white transition-all no-print"
                      >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <h2 className="text-2xl font-black text-slate-800 mb-8 flex items-center gap-3">
                <Plus className="text-secondary" size={28} /> New Member Enrollment
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    >
                      {plans.filter(p => p.type === 'subscription').map(p => (
